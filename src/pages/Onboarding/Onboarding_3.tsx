...
const fullImageClassName =
  "absolute inset-0 h-full w-full max-w-none rounded-full object-cover";
...
const scents: Scent[] = [
  ...
  },
  {
    ...
    layers: [
      {
        image: woodyBaseImage,
        className:
          "absolute inset-0 h-full w-full max-w-none rounded-full object-bottom",
      },
    ...
    layers: [
      {
        image: muskBaseImage,
        className:
          "absolute left-[-4.67%] top-[-24.81%] h-[154.24%] w-[115.72%] max-w-none",
      },
      {
        image: muskImage,
        className:
    ...
    layers: [
      {
        ...
        className:
          "absolute left-[-12.04%] top-[-29.48%] h-[140%] w-[112.04%] max-w-none",
      },
      {
        image: spicyImage,
        className:
  ...
  return (
    <main className="min-h-dvh bg-black max-[430px]:bg-off-white">
      <div className="relative mx-auto min-h-[932px] w-full max-w-[430px] overflow-hidden bg-off-white">
        ...
        <section className="absolute inset-x-0 top-[76px] flex flex-col items-center px-[20px] pb-[50px] pt-[76px]">
